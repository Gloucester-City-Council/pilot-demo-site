    ...
    function initFeedbackWidget() {
        ...
        ratingButtons.forEach(btn => {
            btn.addEventListener('click', function (e) {
                ...
                ratingButtons.forEach(b => b.classList.remove('is-selected'));
        ...
        uiButtons.forEach(btn => {
            btn.addEventListener('click', function (e) {
                e.preventDefault();
                selectedUI = this.getAttribute('data-ui-choice');

                uiButtons.forEach(b => b.classList.remove('is-selected'));
                this.classList.add('is-selected');
            });
        });
        ...
        form.addEventListener('submit', async function (e) {
            ...
            const comments = commentsField ? commentsField.value.trim() || null : null;
            const email = emailField ? emailField.value.trim() || null : null;
            ...
            try {
                const response = await fetch('https://gcc-api-pilot.azurewebsites.net/api/submitFeedback', {
                    ...
                    headers: {
                        ...
                        'x-api-token': 'xxxxxxx' // Use your actual API token here
                    },
